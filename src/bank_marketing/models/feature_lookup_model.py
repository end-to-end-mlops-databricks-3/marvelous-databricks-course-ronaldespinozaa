...
class FeatureLookUpModel:
    ...
    def log_model(self) -> None:
        """Log model to MLflow with Feature Store metadata."""
        ...
        with mlflow.start_run():
            ...
            # Log model using feature store client
            self.fe_client.log_model(
                model=self.pipeline,
                artifact_path="model",
                flavor=mlflow.sklearn,
                ...
                signature=mlflow.models.infer_signature(self.X_train, self.y_train),
            )

        logger.info("✅ Model logged and registered with MLflow and Feature Store.")
